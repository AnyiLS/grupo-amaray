		...
		<svg viewBox="0 0 1920 874.839">
			<defs>
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="37.475 15.054 241.631 119.939">
					<image
						preserveAspectRatio="xMidYMid slice"
						width={316.58}
						height={150.046}
						xlinkHref="/images/history/2023-1-2.png"
					/>
				</pattern>
				<filter
					id="item-107-d"
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="44.304 16.281 420.952 208.948">
					<image
						preserveAspectRatio="xMidYMid slice"
						width={497.761}
						height={235.918}
						xlinkHref="/images/history/2023-1-1.png"
					/>
				</pattern>
				<filter
					id="item-107-l"
			...
			<g transform="translate(0 50.471)">
				...
				<text
					...
					<tspan x={0} y={23}>
						{'El portafolio del Grupo Amarey '}
					</tspan>
					<tspan x={0} y={49}>
						{'sigue creciendo con la '}
					</tspan>
					<tspan x={0} y={75}>
						{'representación de KLS Martin '}
					</tspan>
					<tspan x={0} y={101}>
						{'para ortopedia cráneo '}
					</tspan>
					<tspan x={0} y={127}>
						{'maxilofacial, instrumental y '}
					</tspan>
					<tspan x={0} y={153}>
						{'esterilización'}
					</tspan>
				...
				<g transform="translate(90.016 -322.349)">
					...
					<path
						...
						transform="matrix(-0.259, -0.966, 0.966, -0.259, 1233.521, 1104.09)"
					/>
					<text
