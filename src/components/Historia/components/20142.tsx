...
const LifeLine20142: React.FC<ILifeLine2000> = ({ onClick, onLess }) => {
	return (
			...
			<defs>
				...
				<pattern
					...
					<image
						width={693}
						height={496}
						xlinkHref="/images/history/2014-2-2.png"
					/>
				</pattern>
				<filter
					id="item-107-d"
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="52.332 75.282 414.813 205.901">
					<image
						preserveAspectRatio="xMidYMid slice"
						width={475.286}
						height={356.465}
						xlinkHref="/images/history/2014-2-1.jpg"
					/>
				</pattern>
				<filter
					id="item-107-l"
			...
			<g transform="translate(0 50.471)">
				...
				<g transform="translate(90.016 -322.349)">
					...
					<path
						...
						transform="translate(990.399 1064.889)"
					/>
					<text
