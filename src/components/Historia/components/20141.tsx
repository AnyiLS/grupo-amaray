...
const LifeLine20141: React.FC<ILifeLine2000> = ({ onClick, onLess, handleChangeStepForce }) => {
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				<style>
					{
						'.item-107-a,.item-107-m{fill:#fff;}.item-107-b{fill:#e7002a;}.item-107-c,.item-107-i,.item-107-o,.item-107-q{fill:#001f5f;}.item-107-d{opacity:0.5;fill:url(#item-107-a);}.item-107-e{opacity:0.75;fill:url(#item-107-b);}.item-107-f{fill:none;stroke:#fff;stroke-width:3px;}.item-107-f,.item-107-g{opacity:0.6;}.item-107-h{fill:url(#item-107-c);}.item-107-i{font-size:32px;}.item-107-i,.item-107-m,.item-107-o{font-family:Silka-Bold, Silka;font-weight:700;}.item-107-j{clip-path:url(#item-107-h);}.item-107-k{fill:#182856;font-size:24px;font-family:Silka-Regular, Silka}.item-107-l{fill:#e40032;}.item-107-m{font-size:40px;}.item-107-n{fill:url(#item-107-k);}.item-107-o{font-size:60px;}.item-107-p{opacity:0.7;}.item-107-q{font-size:18px;font-family:Silka-SemiBold, Silka;font-weight:600;}.item-107-r{filter:url(#item-107-r);}.item-107-s{filter:url(#item-107-p);}.item-107-t{filter:url(#item-107-n);}.item-107-u{filter:url(#item-107-l);}.item-107-v{filter:url(#item-107-i);}.item-107-w{filter:url(#item-107-f);}.item-107-x{filter:url(#item-107-d);}'
					}
				</style>
                <linearGradient
        id="item-107-a"
      ...
      <pattern
        ...
        width={1}
        height={1}
        viewBox="44.668 56.188 257.617 127.874"
      >
        <image
          preserveAspectRatio="xMidYMid slice"
          width={302.286}
          height={226.714}
          xlinkHref="/images/history/2014-1.jpg"
        />
      </pattern>
      <filter
        id="item-107-d"
      ...
      <clipPath id="item-107-h">
        <rect className="item-107-a" width={479.319} height={236.689} />
      </clipPath>
      <filter
        id="item-107-i"
        x={1489}
      ...
      <pattern
        ...
        width={1}
        height={1}
        viewBox="21.83 60.127 431.626 214.246"
      >
        <image
          preserveAspectRatio="xMidYMid slice"
          width={475.286}
          height={340.176}
          xlinkHref="/images/history/2014-2.png"
        />
      </pattern>
      <filter
        id="item-107-l"
      ...
      <g transform="translate(0 -329.714)">
        <path
          className="item-107-d"
          d="M761.857,0,0,792.286H1920L1158.142,0Z"
          transform="translate(0 365.714)"
        />
        <path
          className="item-107-e"
          d="M864.554,0,497.566,792.286h924.867L1055.446,0Z"
          transform="translate(0 365.714)"
        />
      </g>
      <line className="item-107-f" x2={1465} transform="translate(227.5 591.786)" />
      <path className="item-107-f" d="M0,0H802" transform="translate(559 243.786)" />
      <g className="item-107-g" transform="translate(686.776)">
        <g className="item-107-x" transform="matrix(1, 0, 0, 1, -686.78, -50.47)">
          <path
            ...
            transform="translate(686.78 50.47)"
          />
        </g>
        <g className="item-107-w" transform="matrix(1, 0, 0, 1, -686.78, -50.47)">
          <path
            className="item-107-a"
            ...
            transform="translate(684.34 33.72)"
          />
        </g>
        <text className="item-107-i" transform="translate(114.24 189.286)">
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
      </g>
      <g className="item-107-j" transform="translate(490.697 261.521)">
        <path
          className="item-107-a"
      ...
      <text className="item-107-k" transform="translate(547.856 351.365)">
        <tspan x={0} y={23}>
          {"Obtiene el Premio Colombiano "}
        </tspan>
        <tspan x={0} y={49}>
      ...
      <g transform="translate(0 -329.714)" onClick={onClick}>
        <g className="item-107-v" transform="matrix(1, 0, 0, 1, 0, 279.24)">
          <path
            className="item-107-l"
        ...
        />
        <text className="item-107-m" transform="translate(1549 1032)">
          <tspan x={0} y={0}>
            {"Avanzar"}
          </tspan>
        </text>
      ...
      <g transform="translate(954.016 212.614)">
        <g className="item-107-u" transform="matrix(1, 0, 0, 1, -954.02, -263.08)">
          <path
            className="item-107-n"
            ...
            transform="translate(954.02 263.08)"
          />
        </g>
        <g className="item-107-t" transform="matrix(1, 0, 0, 1, -954.02, -263.08)">
          <path
            className="item-107-a"
            ...
            transform="translate(961.16 312.35)"
          />
        </g>
        <text className="item-107-o" transform="translate(169 303.672)">
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
      ...
      <g transform="translate(142 649.861)" onClick={onLess}>
        <g className="item-107-s" transform="matrix(1, 0, 0, 1, -142, -700.33)">
          <path
            className="item-107-l"
        ...
        />
        <text className="item-107-m" transform="translate(66 52.425)">
          <tspan x={0} y={0}>
            {"Regresar"}
          </tspan>
        </text>
      ...
      <g transform="translate(90.016 -322.349)">
        <g className="item-107-r" transform="matrix(1, 0, 0, 1, -90.02, 271.88)">
          <rect
            className="item-107-a"
            width={1406}
            height={79}
        ...
        <g className="item-107-p" transform="translate(16.685 -769)">
          <path
            className="item-107-c"
        ...
        <path
          ...
          transform="matrix(-0.259, -0.966, 0.966, -0.259, 917.521, 1104.09)"
        />
        <text className="item-107-q" transform="translate(199 1132)"  onClick={() => handleChangeStepForce(0)}>
          <tspan x={0} y={0}>
            {"1984"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(279 1132)" onClick={() => handleChangeStepForce(1)}>
          <tspan x={0} y={0}>
            {"1999"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(358 1132)" onClick={() => handleChangeStepForce(2)}>
          <tspan x={0} y={0}>
            {"2000"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(441 1132)" onClick={() => handleChangeStepForce(3)}>
          <tspan x={0} y={0}>
            {"2007"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(522 1132)" onClick={() => handleChangeStepForce(4)}>
          <tspan x={0} y={0}>
            {"2009"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(605 1132)" onClick={() => handleChangeStepForce(5)}>
          <tspan x={0} y={0}>
            {"2011"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(681 1132)" onClick={() => handleChangeStepForce(6)}>
          <tspan x={0} y={0}>
            {"2011"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(758 1132)" onClick={() => handleChangeStepForce(7)}>
          <tspan x={0} y={0}>
            {"2012"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(836 1132)" onClick={() => handleChangeStepForce(8)}>
          <tspan x={0} y={0}>
            {"2012"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(915 1132)" onClick={() => handleChangeStepForce(9)}>
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(993 1132)" onClick={() => handleChangeStepForce(10)}>
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(1073 1132)" onClick={() => handleChangeStepForce(11)}>
          <tspan x={0} y={0}>
            {"2016"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(1150 1132)" onClick={() => handleChangeStepForce(12)}>
          <tspan x={0} y={0}>
            {"2017"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(1229 1132)" onClick={() => handleChangeStepForce(13)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(1307 1132)" onClick={() => handleChangeStepForce(14)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(1386 1132)" onClick={() => handleChangeStepForce(15)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-107-q" transform="translate(1464 1132)" onClick={() => handleChangeStepForce(16)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
