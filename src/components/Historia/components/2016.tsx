...
const LifeLine2016: React.FC<ILifeLine2000> = ({ onClick, onLess }) => {
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="0 45.854 302.286 150.046">
					<image
						preserveAspectRatio="xMidYMid slice"
						width={302.286}
						height={201.779}
						xlinkHref="/images/history/2016-2.png"
					/>
				</pattern>
				<filter
					id="item-107-d"
				...
				<pattern
					...
					<image
						width={693}
						height={496}
						xlinkHref="/images/history/2016-1.png"
					/>
				</pattern>
				<filter
					id="item-107-l"
			...
			<g transform="translate(0 50.471)">
				...
				<text
					...
					<tspan x={0} y={23}>
						{'Los Premios Portafolio otorgan '}
					</tspan>
					<tspan x={0} y={49}>
						{'la Mención de Honor a Amarey '}
					</tspan>
					<tspan x={0} y={75}>
						{'Nova Medical en la categoría '}
					</tspan>
					<tspan x={0} y={101}>
				...
				<g transform="translate(90.016 -322.349)">
					...
					<path
						...
						transform="matrix(-0.259, -0.966, 0.966, -0.259, 1075.521, 1104.09)"
					/>
					<text
