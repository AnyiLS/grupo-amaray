...
const LifeLine20233: React.FC<ILifeLine2000> = ({ onClick, onLess }) => {
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="0 14.464 302.286 150.046">
					<image
						preserveAspectRatio="xMidYMid slice"
						width={302.286}
						height={201.524}
						xlinkHref="/images/history/2023-3-2.jpg"
					/>
				</pattern>
				<filter
					id="item-107-d"
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="28.208 29.717 418.869 207.914">
					<image
						preserveAspectRatio="xMidYMid slice"
						width={475.286}
						height={267.349}
						xlinkHref="/images/history/2023-3-1.jpg"
					/>
				</pattern>
				<filter
					id="item-107-l"
			...
			<g transform="translate(0 50.471)">
				...
				<g className="item-107-g" transform="translate(686.776)">
					<g
						className="item-107-x"
						transform="matrix(1, 0, 0, 1, -686.78, -50.47)">
						<path
					...
					<text
						className="item-107-i"
						transform="translate(114.24 189.286)">
						<tspan x={0} y={0}>
							{'2023'}
						</tspan>
					</text>
				...
				<g
					className="item-107-j"
					transform="translate(490.697 261.521)">
					<path
						className="item-107-a"
				...
				<text
					...
					transform="translate(537.856 323.365)">
					<tspan x={0} y={23}>
						{'Grupo Amarey renueva su '}
					</tspan>
					<tspan x={0} y={49}>
						{'identidad de marca, logrando '}
					</tspan>
					<tspan x={0} y={75}>
						{'que refleje los valores, la cultura '}
					</tspan>
					<tspan x={0} y={101}>
				...
				<g transform="translate(954.016 212.614)">
					<g
						className="item-107-u"
						transform="matrix(1, 0, 0, 1, -954.02, -263.08)">
						<path
					...
					<text
						className="item-107-o"
						transform="translate(169 303.672)">
						<tspan x={0} y={0}>
							{'2023'}
						</tspan>
					</text>
				...
				<g transform="translate(90.016 -322.349)">
					...
					<path
						...
						transform="matrix(-0.259, -0.966, 0.966, -0.259, 1391.521, 1104.09)"
					/>
					<text
						className="item-107-q"
