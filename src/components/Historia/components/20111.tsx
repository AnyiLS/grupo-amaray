...
const LifeLine20111: React.FC<ILifeLine2000> = ({ onClick, onLess, handleChangeStepForce }) => {
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				<style>
					{
						'.item-105-a,.item-105-m{fill:#fff;}.item-105-b{fill:#e7002a;}.item-105-c,.item-105-i,.item-105-o,.item-105-q{fill:#001f5f;}.item-105-d{opacity:0.5;fill:url(#item-105-a);}.item-105-e{opacity:0.75;fill:url(#item-105-b);}.item-105-f{fill:none;stroke:#fff;stroke-width:3px;}.item-105-f,.item-105-g{opacity:0.6;}.item-105-h{fill:url(#item-105-c);}.item-105-i{font-size:32px;}.item-105-i,.item-105-m,.item-105-o{font-family:Silka-Bold, Silka;font-weight:700;}.item-105-j{clip-path:url(#item-105-h);}.item-105-k{fill:#182856;font-size:24px;font-family:Silka-Regular, Silka;}.item-105-l{fill:#e40032;}.item-105-m{font-size:40px;}.item-105-n{fill:url(#item-105-k);}.item-105-o{font-size:60px;}.item-105-p{opacity:0.7;}.item-105-q{font-size:18px;font-family:Silka-SemiBold, Silka;font-weight:600;}.item-105-r{filter:url(#item-105-r);}.item-105-s{filter:url(#item-105-p);}.item-105-t{filter:url(#item-105-n);}.item-105-u{filter:url(#item-105-l);}.item-105-v{filter:url(#item-105-i);}.item-105-w{filter:url(#item-105-f);}.item-105-x{filter:url(#item-105-d);}'
					}
				</style>
				<linearGradient
					id="item-105-a"
				...
				<pattern
					...
					<image
						...
						width={302.286}
						height={173.006}
						xlinkHref="/images/history/2011-1-1.jpg"
					/>
				</pattern>
				<filter
					id="item-105-d"
				...
				<clipPath id="item-105-h">
					<rect
						className="item-105-a"
						width={479.319}
						height={236.689}
					/>
				</clipPath>
				...
				<pattern
					...
					<image
						...
						width={475.286}
						height={348.838}
						xlinkHref="/images/history/2011-1-2.jpg"
					/>
				</pattern>
				<filter
					id="item-105-l"
    ...
    <g transform="translate(0 46.348)">
      <g transform="translate(0 -329.714)">
        <path
          className="item-105-d"
          d="M761.857,0,0,792.286H1920L1158.142,0Z"
          transform="translate(0 365.714)"
        />
        <path
          className="item-105-e"
          d="M864.554,0,497.566,792.286h924.867L1055.446,0Z"
          transform="translate(0 365.714)"
        />
      </g>
      <line className="item-105-f" x2={1465} transform="translate(227.5 591.786)" />
      <path className="item-105-f" d="M0,0H802" transform="translate(559 243.786)" />
      <g className="item-105-g" transform="translate(686.776)">
        <g className="item-105-x" transform="matrix(1, 0, 0, 1, -686.78, -46.35)">
          <path
            className="item-105-h"
        ...
        <g className="item-105-w" transform="matrix(1, 0, 0, 1, -686.78, -46.35)">
          <path
            className="item-105-a"
        ...
        <text className="item-105-i" transform="translate(114.24 189.286)">
          <tspan x={0} y={0}>
            {"2011"}
          </tspan>
        </text>
      </g>
      <g className="item-105-j" transform="translate(490.697 261.521)">
        <path
          className="item-105-a"
      ...
      <g transform="translate(0 -329.714)" onClick={onClick}>
        <g className="item-105-v" transform="matrix(1, 0, 0, 1, 0, 283.37)">
          <path
            className="item-105-l"
        ...
        />
        <text className="item-105-m" transform="translate(1549 1032)">
          <tspan x={0} y={0}>
            {"Avanzar"}
          </tspan>
        </text>
      ...
      <g transform="translate(954.016 212.614)">
        <g className="item-105-u" transform="matrix(1, 0, 0, 1, -954.02, -258.96)">
          <path
            className="item-105-n"
        ...
        <g className="item-105-t" transform="matrix(1, 0, 0, 1, -954.02, -258.96)">
          <path
            className="item-105-a"
        ...
        <text className="item-105-o" transform="translate(169 303.672)">
          <tspan x={0} y={0}>
            {"2011"}
          </tspan>
        </text>
      ...
      <g transform="translate(142 649.861)" onClick={onLess}>
        <g className="item-105-s" transform="matrix(1, 0, 0, 1, -142, -696.21)">
          <path
            className="item-105-l"
        ...
        />
        <text className="item-105-m" transform="translate(66 52.425)">
          <tspan x={0} y={0}>
            {"Regresar"}
          </tspan>
        </text>
      ...
      <g transform="translate(90.016 -322.349)">
        <g className="item-105-r" transform="matrix(1, 0, 0, 1, -90.02, 276)">
          <rect
            className="item-105-a"
            width={1406}
            height={79}
        ...
        <g className="item-105-p" transform="translate(16.685 -769)">
          <path
            className="item-105-c"
        ...
        <path
          ...
          transform="matrix(-0.259, -0.966, 0.966, -0.259, 602.521, 1105.09)"
        />
        <text className="item-105-q" transform="translate(199 1132)"  onClick={() => handleChangeStepForce(0)}>
          <tspan x={0} y={0}>
            {"1984"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(279 1132)" onClick={() => handleChangeStepForce(1)}>
          <tspan x={0} y={0}>
            {"1999"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(358 1132)" onClick={() => handleChangeStepForce(2)}>
          <tspan x={0} y={0}>
            {"2000"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(441 1132)" onClick={() => handleChangeStepForce(3)}>
          <tspan x={0} y={0}>
            {"2007"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(522 1132)" onClick={() => handleChangeStepForce(4)}>
          <tspan x={0} y={0}>
            {"2009"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(605 1132)" onClick={() => handleChangeStepForce(5)}>
          <tspan x={0} y={0}>
            {"2011"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(681 1132)" onClick={() => handleChangeStepForce(6)}>
          <tspan x={0} y={0}>
            {"2011"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(758 1132)" onClick={() => handleChangeStepForce(7)}>
          <tspan x={0} y={0}>
            {"2012"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(836 1132)" onClick={() => handleChangeStepForce(8)}>
          <tspan x={0} y={0}>
            {"2012"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(915 1132)" onClick={() => handleChangeStepForce(9)}>
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(993 1132)" onClick={() => handleChangeStepForce(10)}>
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(1073 1132)" onClick={() => handleChangeStepForce(11)}>
          <tspan x={0} y={0}>
            {"2016"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(1150 1132)" onClick={() => handleChangeStepForce(12)}>
          <tspan x={0} y={0}>
            {"2017"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(1229 1132)" onClick={() => handleChangeStepForce(13)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(1307 1132)" onClick={() => handleChangeStepForce(14)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(1386 1132)" onClick={() => handleChangeStepForce(15)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-105-q" transform="translate(1464 1132)" onClick={() => handleChangeStepForce(16)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
