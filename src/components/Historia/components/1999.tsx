...
interface ILifeLine1999 {
	onClick: () => void
	onLess: () => void
  handleChangeStepForce: (index: number) => void
}

const LifeLine1999: React.FC<ILifeLine1999> = ({ onClick, onLess, handleChangeStepForce }): JSX.Element => {
	return (
		<svg viewBox="0 0 1920 874.033">
    <defs>
      <style>
        {
          ".item-101-a,.item-101-m{fill:#fff;}.item-101-b{fill:#e7002a;}.item-101-c,.item-101-i,.item-101-o,.item-101-q{fill:#001f5f;}.item-101-d{opacity:0.5;fill:url(#item-101-a);}.item-101-e{opacity:0.75;fill:url(#item-101-b);}.item-101-f{fill:none;stroke:#fff;stroke-width:3px;}.item-101-f,.item-101-g{opacity:0.6;}.item-101-h{fill:url(#item-101-c);}.item-101-i{font-size:32px;}.item-101-i,.item-101-m,.item-101-o{font-family:Silka-Bold, Silka;font-weight:700;}.item-101-j{clip-path:url(#item-101-h);}.item-101-k{fill:#182856;font-size:24px;font-family:Silka-Regular, Silka;}.item-101-l{fill:#e40032;}.item-101-m{font-size:40px;}.item-101-n{fill:url(#item-101-k);}.item-101-o{font-size:60px;}.item-101-p{opacity:0.7;}.item-101-q{font-size:18px;font-family:Silka-SemiBold, Silka;font-weight:600;}.item-101-r{filter:url(#item-101-r);}.item-101-s{filter:url(#item-101-p);}.item-101-t{filter:url(#item-101-n);}.item-101-u{filter:url(#item-101-l);}.item-101-v{filter:url(#item-101-i);}.item-101-w{filter:url(#item-101-f);}.item-101-x{filter:url(#item-101-d);}"
        }
      </style>
      <linearGradient
        id="item-101-a"
      ...
      <pattern
        ...
        width={1}
        height={1}
        viewBox="91.162 63.566 211.124 104.796"
      >
        <image
          preserveAspectRatio="xMidYMid slice"
          width={302.286}
          height={201.504}
          xlinkHref="/images/history/1999-1.png"
        />
      </pattern>
      <filter
        id="item-101-d"
      ...
      <clipPath id="item-101-h">
        <rect className="item-101-a" width={479.319} height={236.689} />
      </clipPath>
      <filter
        id="item-101-i"
        x={1489}
      ...
      <pattern
        ...
        width={1}
        height={1}
        viewBox="7.931 78.333 459.424 228.044"
      >
        <image
          preserveAspectRatio="xMidYMid slice"
          width={475.286}
          height={316.89}
          xlinkHref="/images/history/1999-2.jpg"
        />
      </pattern>
      <filter
        id="item-101-l"
    ...
    <path
      ...
      transform="translate(-8 -802.11)"
    />
    <g transform="translate(0 45.543)">
      <g transform="translate(0 -329.714)">
        <path
          className="item-101-d"
          d="M761.857,0,0,792.286H1920L1158.142,0Z"
          transform="translate(0 365.714)"
        />
        <path
          className="item-101-e"
          d="M864.554,0,497.566,792.286h924.867L1055.446,0Z"
          transform="translate(0 365.714)"
        />
      </g>
      <line className="item-101-f" x2={1465} transform="translate(227.5 591.786)" />
      <path className="item-101-f" d="M0,0H802" transform="translate(559 243.786)" />
      <g className="item-101-g" transform="translate(686.776)">
        <g className="item-101-x" transform="matrix(1, 0, 0, 1, -686.78, -45.54)">
          <path
            className="item-101-h"
            ...
            transform="translate(686.78 45.54)"
          />
        </g>
        <g className="item-101-w" transform="matrix(1, 0, 0, 1, -686.78, -45.54)">
          <path
            className="item-101-a"
            ...
            transform="translate(684.34 28.79)"
          />
        </g>
        <text className="item-101-i" transform="translate(114.24 189.286)">
          <tspan x={0} y={0}>
            {"2000"}
          </tspan>
        </text>
      </g>
      <g className="item-101-j" transform="translate(490.697 261.521)">
        <path
          className="item-101-a"
          d="M30.9,236.689h417.5a30.9,30.9,0,0,0,30.529-35.712L451.4,26.1A30.9,30.9,0,0,0,420.867,0H30.9A30.9,30.9,0,0,0,0,30.906V205.785a30.9,30.9,0,0,0,30.9,30.9"
          transform="translate(-0.001)"
        />
      </g>
      <text className="item-101-k" transform="translate(531.983 309.365)">
        <tspan x={0} y={23}>
          {"Se crea la línea respiratoria con "}
        </tspan>
        <tspan x={0} y={49}>
          {"el lanzamiento de un "}
        </tspan>
        <tspan x={0} y={75}>
          {"surfactante pulmonar para el "}
        </tspan>
        <tspan x={0} y={101}>
      ...
      <g transform="translate(0 -329.714)" onClick={onClick}>
        <g className="item-101-v" transform="matrix(1, 0, 0, 1, 0, 284.17)">
          <path
            className="item-101-l"
            d="M280,0H57.432C34.283,0,13.5,23.591,5.042,59.456L0,80.849H220.722c24.663,0,46.745-25.435,55.433-63.849Z"
            transform="translate(1498 695.4)"
          />
        </g>
        <path
          className="item-101-a"
        ...
        />
        <text className="item-101-m" transform="translate(1549 1032)">
          <tspan x={0} y={0}>
            {"Avanzar"}
          </tspan>
        </text>
      </g>
      <g transform="translate(954.016 212.614)">
        <g className="item-101-u" transform="matrix(1, 0, 0, 1, -954.02, -258.16)">
          <path
            className="item-101-n"
            d="M475.12,28.858l-34.461,207.06h-323.7c-52.251,0-83.966-37.809-90.637-54.545L.181,28.954C-1.454,13.619,8.213,0,20.718,0H454.568c12.478,0,22.116,13.55,20.552,28.858"
            transform="translate(954.02 258.16)"
          />
        </g>
        <g className="item-101-t" transform="matrix(1, 0, 0, 1, -954.02, -258.16)">
          <path
            className="item-101-a"
            ...
            transform="translate(961.16 307.42)"
          />
        </g>
        <text className="item-101-o" transform="translate(169 303.672)">
          <tspan x={0} y={0}>
            {"1999"}
          </tspan>
        </text>
      ...
      <g transform="translate(142 649.861)" onClick={onLess}>
        ...
        />
        <text className="item-101-m" transform="translate(66 52.425)">
          <tspan x={0} y={0}>
            {"Regresar"}
          </tspan>
        </text>
      ...
      <g transform="translate(90.016 -322.349)">
        <g className="item-101-r" transform="matrix(1, 0, 0, 1, -90.02, 276.81)">
          <rect
            className="item-101-a"
            width={1406}
            height={79}
            rx={39.5}
            transform="translate(238 783.03)"
          />
        </g>
        <g className="item-101-p" transform="translate(16.685 -769)">
          <path
            className="item-101-c"
        ...
        <path
          ...
          transform="matrix(-0.259, -0.966, 0.966, -0.259, 287.521, 1104.09)"
        />
        <text className="item-101-q" transform="translate(199 1132)" onClick={() => handleChangeStepForce(0)}>
          <tspan x={0} y={0}>
            {"1984"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(279 1132)"  onClick={() => handleChangeStepForce(1)}>
          <tspan x={0} y={0}>
            {"1999"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(358 1132)" onClick={() => handleChangeStepForce(2)}>
          <tspan x={0} y={0}>
            {"2000"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(441 1132)" onClick={() => handleChangeStepForce(3)}>
          <tspan x={0} y={0}>
            {"2007"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(522 1132)" onClick={() => handleChangeStepForce(4)}>
          <tspan x={0} y={0}>
            {"2009"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(605 1132)"  onClick={() => handleChangeStepForce(5)}>
          <tspan x={0} y={0}>
            {"2011"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(681 1132)"  onClick={() => handleChangeStepForce(6)}>
          <tspan x={0} y={0}>
            {"2011"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(758 1132)"  onClick={() => handleChangeStepForce(7)}>
          <tspan x={0} y={0}>
            {"2012"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(836 1132)" onClick={() => handleChangeStepForce(8)}>
          <tspan x={0} y={0}>
            {"2012"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(915 1132)"  onClick={() => handleChangeStepForce(9)}>
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(993 1132)" onClick={() => handleChangeStepForce(10)}>
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(1073 1132)"  onClick={() => handleChangeStepForce(11)}>
          <tspan x={0} y={0}>
            {"2016"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(1150 1132)"  onClick={() => handleChangeStepForce(12)}>
          <tspan x={0} y={0}>
            {"2017"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(1229 1132)"  onClick={() => handleChangeStepForce(13)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(1307 1132)"  onClick={() => handleChangeStepForce(14)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(1386 1132)"  onClick={() => handleChangeStepForce(15)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-101-q" transform="translate(1464 1132)"  onClick={() => handleChangeStepForce(16)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
