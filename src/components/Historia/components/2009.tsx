	...
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				<style>
					{
						'.item-104-a,.item-104-m{fill:#fff;}.item-104-b{fill:#e7002a;}.item-104-c,.item-104-i,.item-104-o,.item-104-q{fill:#001f5f;}.item-104-d{opacity:0.5;fill:url(#item-104-a);}.item-104-e{opacity:0.75;fill:url(#item-104-b);}.item-104-f{fill:none;stroke:#fff;stroke-width:3px;}.item-104-f,.item-104-g{opacity:0.6;}.item-104-h{fill:url(#item-104-c);}.item-104-i{font-size:32px;}.item-104-i,.item-104-m,.item-104-o{font-family:Silka-Bold, Silka;font-weight:700;}.item-104-j{clip-path:url(#item-104-h);}.item-104-k{fill:#182856;font-size:24px;font-family:Silka-Regular, Silka;}.item-104-l{fill:#e40032;}.item-104-m{font-size:40px;}.item-104-n{fill:url(#item-104-k);}.item-104-o{font-size:60px;}.item-104-p{opacity:0.7;}.item-104-q{font-size:18px;font-family:Silka-SemiBold, Silka;font-weight:600;}.item-104-r{filter:url(#item-104-r);}.item-104-s{filter:url(#item-104-p);}.item-104-t{filter:url(#item-104-n);}.item-104-u{filter:url(#item-104-l);}.item-104-v{filter:url(#item-104-i);}.item-104-w{filter:url(#item-104-f);}.item-104-x{filter:url(#item-104-d);}'
					}
				</style>
				<linearGradient
					id="item-104-a"
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="0 43.062 302.286 150.046">
					<image
				...
				<clipPath id="item-104-h">
					<rect
						className="item-104-a"
						width={479.319}
						height={236.689}
					/>
				</clipPath>
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="38.834 10.572 397.619 197.366">
					<image
						preserveAspectRatio="xMidYMid slice"
						width={475.286}
						height={272.019}
			...
			<g transform="translate(0 50.471)">
				...
				/>
				<g className="item-104-g" transform="translate(-471.046 -1559)">
					<g
						className="item-104-x"
						transform="matrix(1, 0, 0, 1, 471.05, 1508.53)">
						<path
							className="item-104-h"
				...
				<g className="item-104-j" transform="translate(960 261.521)">
					<path
						className="item-104-a"
				...
				<text
					...
					<tspan x={0} y={75}>
						{'implantes ortopédicos de Stryker, '}
					</tspan>
					<tspan x={0} y={101}>
						{'equipos médicos, pruebas '}
					</tspan>
					<tspan x={0} y={127}>
						{'diagnósticas oncológicas y '}
					</tspan>
					<tspan x={0} y={153}>
				...
				<g transform="translate(0 -329.714)" onClick={onClick}>
					<g
						className="item-104-v"
						transform="matrix(1, 0, 0, 1, 0, 279.24)">
						<path
							className="item-104-l"
				...
				<g transform="translate(-911.287 -1346.386)">
					<g
						className="item-104-u"
						transform="matrix(1, 0, 0, 1, 911.29, 1295.92)">
						<path
							className="item-104-n"
				...
				<g transform="translate(90.016 -322.349)">
					...
					<path
						...
						transform="translate(517.399 1064.889)"
					/>
					<text
