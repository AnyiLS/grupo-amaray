...
const LifeLine2012: React.FC<ILifeLine2000> = ({ onClick, onLess }) => {
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="41.465 70.784 219.357 108.882">
					<image
