...
const LifeLine2007: React.FC<ILifeLine2000> = ({ onClick, onLess, handleChangeStepForce }) => {
    ...
    <defs>
      <style>
        {
          ".item-103-a,.item-103-m{fill:#fff;}.item-103-b{fill:#e7002a;}.item-103-c,.item-103-i,.item-103-o,.item-103-q{fill:#001f5f;}.item-103-d{opacity:0.5;fill:url(#item-103-a);}.item-103-e{opacity:0.75;fill:url(#item-103-b);}.item-103-f{fill:none;stroke:#fff;stroke-width:3px;}.item-103-f,.item-103-g{opacity:0.6;}.item-103-h{fill:url(#item-103-c);}.item-103-i{font-size:32px;}.item-103-i,.item-103-m,.item-103-o{font-family:Silka-Bold, Silka;font-weight:700;}.item-103-j{clip-path:url(#item-103-h);}.item-103-k{fill:#182856;font-size:24px;font-family:Silka-Regular, Silka;}.item-103-l{fill:#e40032;}.item-103-m{font-size:40px;}.item-103-n{fill:url(#item-103-k);}.item-103-o{font-size:60px;}.item-103-p{opacity:0.7;}.item-103-q{font-size:18px;font-family:Silka-SemiBold, Silka;font-weight:600;}.item-103-r{filter:url(#item-103-r);}.item-103-s{filter:url(#item-103-p);}.item-103-t{filter:url(#item-103-n);}.item-103-u{filter:url(#item-103-l);}.item-103-v{filter:url(#item-103-i);}.item-103-w{filter:url(#item-103-f);}.item-103-x{filter:url(#item-103-d);}"
        }
      </style>
      <linearGradient
        id="item-103-a"
      ...
      <pattern
        ...
        width={1}
        height={1}
        viewBox="37.858 17.29 226.57 112.463"
      >
        <image
          preserveAspectRatio="xMidYMid slice"
          width={302.286}
          height={173.006}
          xlinkHref="/images/history/2007-1.png"
        />
      </pattern>
      <filter
        id="item-103-d"
      ...
      <clipPath id="item-103-h">
        <rect className="item-103-a" width={479.319} height={236.689} />
      </clipPath>
      <filter
        id="item-103-i"
        x={1489}
      ...
      <pattern
        ...
        width={1}
        height={1}
        viewBox="55.433 83.975 364.419 180.887"
      >
        <image
          preserveAspectRatio="xMidYMid slice"
          width={475.286}
          height={348.838}
          xlinkHref="/images/history/2007-2.png"
        />
      </pattern>
      <filter
        id="item-103-l"
    ...
    />
    <g transform="translate(0 46.348)">
      <g transform="translate(0 -329.714)">
        <path
          className="item-103-d"
          d="M761.857,0,0,792.286H1920L1158.142,0Z"
          transform="translate(0 365.714)"
        />
        <path
          className="item-103-e"
          d="M864.554,0,497.566,792.286h924.867L1055.446,0Z"
          transform="translate(0 365.714)"
        />
      </g>
      <line className="item-103-f" x2={1465} transform="translate(227.5 591.786)" />
      <path className="item-103-f" d="M0,0H802" transform="translate(559 243.786)" />
      <g className="item-103-g" transform="translate(686.776)">
        <g className="item-103-x" transform="matrix(1, 0, 0, 1, -686.78, -46.35)">
          <path
            className="item-103-h"
            ...
            transform="translate(686.78 46.35)"
          />
        </g>
        <g className="item-103-w" transform="matrix(1, 0, 0, 1, -686.78, -46.35)">
          <path
            className="item-103-a"
            ...
            transform="translate(684.34 29.59)"
          />
        </g>
        <text className="item-103-i" transform="translate(114.24 189.286)">
          <tspan x={0} y={0}>
            {"2009"}
          </tspan>
        </text>
      </g>
      <g className="item-103-j" transform="translate(490.697 261.521)">
        <path
          className="item-103-a"
      ...
      <g transform="translate(0 -329.714)" onClick={onClick}>
        <g className="item-103-v" transform="matrix(1, 0, 0, 1, 0, 283.37)">
          <path
            className="item-103-l"
            d="M280,0H57.432C34.283,0,13.5,23.591,5.042,59.456L0,80.849H220.722c24.663,0,46.745-25.435,55.433-63.849Z"
            transform="translate(1498 696.21)"
          />
        </g>
        <path
          className="item-103-a"
        ...
        />
        <text className="item-103-m" transform="translate(1549 1032)">
          <tspan x={0} y={0}>
            {"Avanzar"}
          </tspan>
        </text>
      ...
      <g transform="translate(954.016 212.614)">
        <g className="item-103-u" transform="matrix(1, 0, 0, 1, -954.02, -258.96)">
          <path
            className="item-103-n"
            ...
            transform="translate(954.02 258.96)"
          />
        </g>
        <g className="item-103-t" transform="matrix(1, 0, 0, 1, -954.02, -258.96)">
          <path
            className="item-103-a"
            ...
            transform="translate(961.16 308.23)"
          />
        </g>
        <text className="item-103-o" transform="translate(169 303.672)">
          <tspan x={0} y={0}>
            {"2007"}
          </tspan>
        </text>
      ...
      <g transform="translate(142 649.861)" onClick={onLess}>
        ...
        />
        <text className="item-103-m" transform="translate(66 52.425)">
          <tspan x={0} y={0}>
            {"Regresar"}
          </tspan>
        </text>
      ...
      <g transform="translate(90.016 -322.349)">
        <g className="item-103-r" transform="matrix(1, 0, 0, 1, -90.02, 276)">
          <rect
            className="item-103-a"
            width={1406}
            height={79}
            rx={39.5}
            transform="translate(238 783.84)"
          />
        </g>
        <g className="item-103-p" transform="translate(16.685 -769)">
          <path
            className="item-103-c"
        ...
        <path
          ...
          transform="matrix(-0.259, -0.966, 0.966, -0.259, 444.521, 1104.09)"
        />
        <text className="item-103-q" transform="translate(199 1132)"  onClick={() => handleChangeStepForce(0)}>
          <tspan x={0} y={0}>
            {"1984"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(279 1132)"  onClick={() => handleChangeStepForce(1)}>
          <tspan x={0} y={0}>
            {"1999"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(358 1132)"  onClick={() => handleChangeStepForce(2)}>
          <tspan x={0} y={0}>
            {"2000"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(441 1132)" onClick={() => handleChangeStepForce(3)}>
          <tspan x={0} y={0}>
            {"2007"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(522 1132)" onClick={() => handleChangeStepForce(4)}>
          <tspan x={0} y={0}>
            {"2009"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(605 1132)" onClick={() => handleChangeStepForce(5)}>
          <tspan x={0} y={0}>
            {"2011"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(681 1132)" onClick={() => handleChangeStepForce(6)}>
          <tspan x={0} y={0}>
            {"2011"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(758 1132)" onClick={() => handleChangeStepForce(7)}>
          <tspan x={0} y={0}>
            {"2012"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(836 1132)" onClick={() => handleChangeStepForce(8)}>
          <tspan x={0} y={0}>
            {"2012"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(915 1132)" onClick={() => handleChangeStepForce(9)}>
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(993 1132)" onClick={() => handleChangeStepForce(10)}>
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(1073 1132)" onClick={() => handleChangeStepForce(11)}>
          <tspan x={0} y={0}>
            {"2016"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(1150 1132)" onClick={() => handleChangeStepForce(12)}>
          <tspan x={0} y={0}>
            {"2017"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(1229 1132)" onClick={() => handleChangeStepForce(13)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(1307 1132)" onClick={() => handleChangeStepForce(14)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(1386 1132)" onClick={() => handleChangeStepForce(15)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
        <text className="item-103-q" transform="translate(1464 1132)" onClick={() => handleChangeStepForce(16)}>
          <tspan x={0} y={0}>
            {"2023"}
          </tspan>
        </text>
