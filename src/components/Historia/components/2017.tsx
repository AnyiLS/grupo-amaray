...
const LifeLine2017: React.FC<ILifeLine2000> = ({ onClick, onLess }) => {
	return (
			...
			<defs>
				...
				<pattern
					...
					<image
						width={768}
						height={364}
						xlinkHref="/images/history/2017-2.png"
					/>
				</pattern>
				<filter
					id="item-107-d"
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="0 75.315 475.286 235.918">
					<image
						preserveAspectRatio="xMidYMid slice"
						width={475.286}
						height={317.259}
						xlinkHref="/images/history/2017-1.png"
					/>
				</pattern>
				<filter
					id="item-107-l"
			...
			<g transform="translate(0 50.471)">
				...
				<g transform="translate(90.016 -322.349)">
					...
					<path
						...
						transform="translate(1147.399 1064.889)"
					/>
					<text
