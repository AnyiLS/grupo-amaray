...
const LifeLine20122: React.FC<ILifeLine2000> = ({ onClick, onLess, handleChangeStepForce }) => {
	return (
      ...
      <pattern
        ...
        width={1}
        height={1}
        viewBox="15.278 40.738 271.73 134.879"
      >
        <image
          preserveAspectRatio="xMidYMid slice"
          width={302.286}
          height={216.355}
          xlinkHref="/images/history/2012-2-1.png"
        />
      </pattern>
      <filter
        id="item-107-d"
      ...
      <pattern
        ...
        width={1}
        height={1}
        viewBox="43.021 108.031 360.588 178.985"
      >
        <image
          preserveAspectRatio="xMidYMid slice"
          width={475.286}
          height={488.832}
          xlinkHref="/images/history/2012-1-2.jpg"
        />
      </pattern>
      <filter
        id="item-107-l"
      ...
      <g transform="translate(0 -327.714)">
        <path
      ...
      <g className="item-107-g" transform="translate(-471.047 -1559)">
        <g className="item-107-x" transform="matrix(1, 0, 0, 1, 471.05, 1508.53)">
          <path
        ...
        <g className="item-107-w" transform="matrix(1, 0, 0, 1, 471.05, 1508.53)">
          <path
        ...
        <text className="item-107-i" transform="translate(1528.046 1748.286)">
          <tspan x={0} y={0}>
            {"2014"}
          </tspan>
        </text>
      </g>
      <g className="item-107-j" transform="translate(960 261.521)">
        <path
          className="item-107-a"
      ...
      <text className="item-107-k" transform="translate(1026 337.286)">
        <tspan x={0} y={23}>
          {"Se inauguran cinco sedes "}
        </tspan>
        <tspan x={0} y={49}>
          {"propias en Bogotá, Cali, "}
        </tspan>
        <tspan x={0} y={75}>
          {"Medellín, Barranquilla y Pereira"}
        </tspan>
      </text>
      ...
      <g transform="translate(-911.287 -1346.386)">
        <g className="item-107-u" transform="matrix(1, 0, 0, 1, 911.29, 1295.92)">
          <path
        ...
        <g className="item-107-t" transform="matrix(1, 0, 0, 1, 911.29, 1295.92)">
          <path
            className="item-107-a"
        ...
        <text className="item-107-o" transform="translate(1580.287 1862.672)">
          <tspan x={0} y={0}>
            {"2012"}
          </tspan>
        </text>
      ...
      <g transform="translate(90.015 -322.349)">
        ...
        <path
          ...
          transform="translate(832.776 1064.889)"
        />
