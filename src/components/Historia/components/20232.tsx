...
const LifeLine20232: React.FC<ILifeLine2000> = ({ onClick, onLess, handleChangeStepForce }) => {
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="21.133 20.485 260.02 129.066">
					<image
						preserveAspectRatio="xMidYMid slice"
						width={302.286}
						height={170.036}
						xlinkHref="/images/history/2023-2-2.jpg"
					/>
				</pattern>
				<filter
					id="item-107-d"
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="61.659 12.431 374.443 185.862">
					<image
						preserveAspectRatio="xMidYMid slice"
						width={497.761}
						height={235.918}
						xlinkHref="/images/history/2023-2-1.png"
					/>
				</pattern>
				<filter
					id="item-107-l"
			...
			<g transform="translate(0 50.471)">
				...
				/>
				<g className="item-107-g" transform="translate(-471.046 -1559)">
					<g
				...
				<text
					...
					transform="translate(1035 309.286)">
					<tspan x={0} y={23}>
						{'Se crea la línea de '}
					</tspan>
					<tspan x={0} y={49}>
						{'neurointervencionismo con '}
					</tspan>
					<tspan x={0} y={75}>
						{'la llegada del portafolio de '}
					</tspan>
					<tspan x={0} y={101}>
						{'CERENOVUS para el '}
					</tspan>
				...
				<g transform="translate(90.016 -322.349)">
					...
					<path
						...
						transform="translate(1306 1064.889)"
					/>
					<text
