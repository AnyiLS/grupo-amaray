...
const LifeLine2000: React.FC<ILifeLine2000> = ({ onClick, onLess }): JSX.Element => {
    return (
        ...
        <defs>
          <style>
            {
              ".item-102-a,.item-102-m{fill:#fff;}.item-102-b{fill:#e7002a;}.item-102-c,.item-102-i,.item-102-o,.item-102-q{fill:#001f5f;}.item-102-d{opacity:0.5;fill:url(#item-102-a);}.item-102-e{opacity:0.75;fill:url(#item-102-b);}.item-102-f{fill:none;stroke:#fff;stroke-width:3px;}.item-102-f,.item-102-g{opacity:0.6;}.item-102-h{fill:url(#item-102-c);}.item-102-i{font-size:32px;}.item-102-i,.item-102-m,.item-102-o{font-family:Silka-Bold, Silka;font-weight:700;}.item-102-j{clip-path:url(#item-102-h);}.item-102-k{fill:#182856;font-size:24px;font-family:Silka-Regular, Silka;}.item-102-l{fill:#e40032;}.item-102-m{font-size:40px;}.item-102-n{fill:url(#item-102-k);}.item-102-o{font-size:60px;}.item-102-p{opacity:0.7;}.item-102-q{font-size:18px;font-family:Silka-SemiBold, Silka;font-weight:600;}.item-102-r{filter:url(#item-102-r);}.item-102-s{filter:url(#item-102-p);}.item-102-t{filter:url(#item-102-n);}.item-102-u{filter:url(#item-102-l);}.item-102-v{filter:url(#item-102-i);}.item-102-w{filter:url(#item-102-f);}.item-102-x{filter:url(#item-102-d);}"
            }
          </style>
          <linearGradient
            id="item-102-a"
          ...
          <pattern
            ...
            width={1}
            height={1}
            viewBox="25.863 48.747 250.56 124.371"
          >
            <image
              preserveAspectRatio="xMidYMid slice"
              width={302.286}
              height={221.864}
              xlinkHref="/images/history/2000-1.png"
            />
          </pattern>
          <filter
            id="item-102-d"
          ...
          <clipPath id="item-102-h">
            <rect className="item-102-a" width={479.319} height={236.689} />
          </clipPath>
          <filter
            id="item-102-i"
            x={1489}
          ...
          <pattern
            ...
            width={1}
            height={1}
            viewBox="147.235 100.121 317.858 157.775"
          >
            <image
              preserveAspectRatio="xMidYMid slice"
              width={475.286}
              height={316.827}
              xlinkHref="/images/history/2000-2.png"
            />
          </pattern>
          <filter
            id="item-102-l"
        ...
        />
        <g transform="translate(0 -283.366)">
          <path
            className="item-102-d"
            d="M761.857,0,0,792.286H1920L1158.142,0Z"
            transform="translate(0 365.714)"
          />
          <path
            className="item-102-e"
            d="M864.554,0,497.566,792.286h924.867L1055.446,0Z"
            transform="translate(0 365.714)"
          />
        </g>
        <line className="item-102-f" x2={1465} transform="translate(227.5 638.134)" />
        <path className="item-102-f" d="M0,0H802" transform="translate(559 290.134)" />
        <g className="item-102-g" transform="translate(-471.046 -1512.652)">
          <g className="item-102-x" transform="matrix(1, 0, 0, 1, 471.05, 1512.65)">
            <path
              className="item-102-h"
              ...
              transform="translate(940.95 46.35)"
            />
          </g>
          <g className="item-102-w" transform="matrix(1, 0, 0, 1, 471.05, 1512.65)">
            <path
              className="item-102-a"
              ...
              transform="translate(938.52 29.59)"
            />
          </g>
          <text className="item-102-i" transform="translate(1528.046 1748.286)">
            <tspan x={0} y={0}>
              {"2007"}
            </tspan>
          </text>
        </g>
        <g className="item-102-j" transform="translate(960 307.869)">
          <path
            className="item-102-a"
        ...
        <text className="item-102-k" transform="translate(1074 383.634)">
          ...
          <tspan x={0} y={49} xmlSpace="preserve">
        ...
        <g transform="translate(0 -283.366)" onClick={onClick}>
          <g className="item-102-v" transform="matrix(1, 0, 0, 1, 0, 283.37)">
            <path
              className="item-102-l"
          ...
          />
          <text className="item-102-m" transform="translate(1549 1032)">
            <tspan x={0} y={0}>
              {"Avanzar"}
            </tspan>
          </text>
        </g>
        <g transform="translate(-911.287 -1300.038)">
          <g className="item-102-u" transform="matrix(1, 0, 0, 1, 911.29, 1300.04)">
            <path
              className="item-102-n"
              ...
              transform="translate(500.71 258.96)"
            />
          </g>
          <g className="item-102-t" transform="matrix(1, 0, 0, 1, 911.29, 1300.04)">
            <path
              className="item-102-a"
              ...
              transform="translate(507.86 308.23)"
            />
          </g>
          <text className="item-102-o" transform="translate(1580.287 1862.672)">
            <tspan x={0} y={0}>
              {"2000"}
            </tspan>
          </text>
        </g>
        <g transform="translate(142 696.21)" onClick={onLess}>
          <g className="item-102-s" transform="matrix(1, 0, 0, 1, -142, -696.21)">
            <path
              className="item-102-l"
          ...
          />
          <text className="item-102-m" transform="translate(66 52.425)">
            <tspan x={0} y={0}>
              {"Regresar"}
            </tspan>
          </text>
        </g>
        <g transform="translate(90.016 -276.001)">
          <g className="item-102-r" transform="matrix(1, 0, 0, 1, -90.02, 276)">
            <rect
              className="item-102-a"
              width={1406}
              height={79}
          ...
          <g className="item-102-p" transform="translate(16.685 -769)">
            <path
              className="item-102-c"
