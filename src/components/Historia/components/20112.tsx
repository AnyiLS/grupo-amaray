...
const LifeLine20112: React.FC<ILifeLine2000> = ({ onClick, onLess, handleChangeStepForce }) => {
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				...
				<pattern
					...
					<image
						width={1018}
						height={702}
						xlinkHref="/images/history/2012-1-2.png"
					/>
				</pattern>
				<filter
					id="item-106-d"
				...
				<pattern
					...
					<image
						...
						width={475.286}
						height={316.858}
						xlinkHref="/images/history/2011-2-2.jpg"
					/>
				</pattern>
				<filter
					id="item-106-l"
			...
			<g transform="translate(0 50.471)">
				...
				/>
				<g className="item-106-g" transform="translate(-471.046 -1559)">
					<g
				...
				<g className="item-106-j" transform="translate(960 261.521)">
					<path
						className="item-106-a"
				...
				<text
					...
					transform="translate(1030 332.286)">
					<tspan x={0} y={0}>
						{'Grupo Amarey obtiene la '}
					</tspan>
					<tspan x={0} y={26}>
						{'representación del sistema '}
					</tspan>
					<tspan x={0} y={52}>
						{'robótico da Vinci en Colombia '}
					</tspan>
					<tspan x={0} y={78}>
						{'para cirugía mínimamente '}
					</tspan>
					<tspan x={0} y={104}>
						{'invasiva'}
					</tspan>
