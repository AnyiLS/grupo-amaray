...
const LifeLine20234: React.FC<ILifeLine2000> = ({ onClick, onLess }) => {
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				<style>
					{
						'.item-107-a,.item-107-j{fill:#fff;}.item-107-b{fill:#e7002a;}.item-107-c,.item-107-l,.item-107-n{fill:#001f5f;}.item-107-d{opacity:0.5;fill:url(#item-107-a);}.item-107-e{opacity:0.75;fill:url(#item-107-b);}.item-107-f{fill:none;stroke:#fff;stroke-width:3px;opacity:0.6;}.item-107-g{clip-path:url(#item-107-c);}.item-107-h{fill:#182856;font-size:24px;font-family:Silka-Regular, Silka;}.item-107-i{fill:#e40032;}.item-107-j{font-size:40px;}.item-107-j,.item-107-l{font-family:Silka-Bold, Silka;font-weight:700;}.item-107-k{fill:url(#item-107-f);}.item-107-l{font-size:60px;}.item-107-m{opacity:0.7;}.item-107-n{font-size:18px;font-family:Silka-SemiBold, Silka;font-weight:600;}.item-107-o{filter:url(#item-107-m);}.item-107-p{filter:url(#item-107-k);}.item-107-q{filter:url(#item-107-i);}.item-107-r{filter:url(#item-107-g);}.item-107-s{filter:url(#item-107-d);}'
					}
				</style>
				<linearGradient
					id="item-107-a"
				...
				<pattern
					...
					width={1}
					height={1}
					viewBox="0 20.267 475.286 235.918">
					<image
			...
			/>
			<g transform="translate(0 86.471)">
				<g transform="translate(0 -365.714)">
					<path
				...
				<line
					...
					x2={1465}
					transform="translate(227.5 555.786)"
				/>
				<g className="item-107-g" transform="translate(960 225.521)">
					<path
						className="item-107-a"
				...
				<text
					...
					<tspan x={0} y={26}>
						{'Distribución Logística – CEDI en '}
					</tspan>
					<tspan x={0} y={52}>
						{'la zona industrial de Montevideo '}
					</tspan>
					<tspan x={0} y={78}>
						{'en Bogotá, con el objetivo de '}
					</tspan>
					<tspan x={0} y={104}>
						{'lograr mejores niveles de servicio '}
					</tspan>
					<tspan x={0} y={130}>
						{'logístico para los clientes'}
					</tspan>
				</text>
				<g transform="translate(0 -365.714)" onClick={onClick}>
					<g
				...
				<g transform="translate(-911.287 -1382.386)">
					<g
				...
				<g transform="translate(142 613.861)" onClick={onLess}>
					<g
				...
				<g transform="translate(90.016 -358.349)">
					<g
					...
					<path
						...
						transform="translate(1464 1064.889)"
					/>
					<text
