...
const Feb9: React.FC<ICalendar> = ({ month, next, prev, today, onChangeDay, onChangeMonth, onLessMonth }) => {
	...
	return (
		<svg viewBox="-150 0 1920 998.106">
			...
			<text className="p-item-1813" transform="translate(1436 742.019)">
				<tspan x={-384.188} y={0}>
					{'I congreso de oncología'}
				</tspan>
			</text>
			<text className="q-item-1813" transform="translate(1435 761.019)">
			...
			<rect
				...
				height={4}
				rx={2}
				transform="translate(425 558.019)"
			/>
		</svg>
	)
}
