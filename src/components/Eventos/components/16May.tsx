...
const May16: React.FC<ICalendar> = ({ month, next, prev, today, onChangeDay, onChangeMonth, onLessMonth }) => {
    ...
    <text className="m-item-1813" transform="translate(997.478 126.019)">
      <tspan x={0} y={0}>
        {"16 de mayo de 2024"}
      </tspan>
    </text>
    ...
    <rect
      ...
      height={4}
      rx={2}
      transform="translate(350 606.019)"
    />
		</svg>
	)
}
