...
const May22: React.FC<ICalendar> = ({ month, next, prev, today, onChangeDay, onChangeMonth, onLessMonth }) => {
    ...
    <text className="i-item-1813" transform="translate(1006.135 126.019)">
      <tspan x={0} y={0}>
        {"22 de mayo de 2024"}
      </tspan>
    </text>
    ...
    <g transform="translate(-140 -133.894)">
      ...
      <g className="l-item-1813" transform="translate(140 610)">
        <g transform="translate(-140 -557)">
          <text className="m-item-1813" transform="translate(165 557)">
            <tspan x={-14.508} y={23}>
              {"28"}
            </tspan>
          </text>
        ...
        <g transform="translate(32 -557)"  onClick={() => onChangeDay(30)}>
          <text className="m-item-1813" transform="translate(165 557)">
            <tspan x={-14.7} y={23}>
              {"30"}
            </tspan>
      ...
      <line className="o-item-1813" x2={567} transform="translate(140 546)" />
      <path
        className="c-item-1813"
        d="M13.947,0,27.893,23.908H0Z"
    ...
    <text className="q-item-1813" transform="translate(1436 737.019)">
      <tspan x={-416.584} y={0}>
    ...
    <text className="r-item-1813" transform="translate(1435 786.019)">
      <tspan x={-339.462} y={17}>
