...
const May04: React.FC<ICalendar> = ({ month, next, prev, today, onChangeDay }) => {
	...
	return (
		<svg viewBox="-150 0 1920 998.106">
			...
			<text
				...
				transform="translate(993.979 126.019)">
				<tspan x={0} y={0}>
					{'04 de mayo de 2024'}
				</tspan>
			</text>
			<rect
				...
				height={4}
				rx={2}
				transform="translate(521.5 509.019)"
			/>
			...
			<text className="s-item-1813" transform="translate(1578 708.106)">
