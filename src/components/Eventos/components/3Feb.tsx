...
const Feb3: React.FC<ICalendar> = ({ month, next, prev, today, onChangeDay }) => {
	...
	return (
		<svg viewBox="-150 0 1920 998.106">
			...
			<text className="p-item-1813" transform="translate(1436 737.019)">
				...
				<tspan x={-162.204} y={30}>
					{'Residentes'}
				</tspan>
			</text>
			<text className="q-item-1813" transform="translate(1435 780)">
				<tspan x={-345.636} y={17}>
			...
			<rect
				...
				height={4}
				rx={2}
				transform="translate(522 509.019)"
			/>
		</svg>
	)
}
